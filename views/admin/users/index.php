...
<form method="get" action="/admin/users" class="cluster mb-md">
  <input type="text" name="q" value="<?= e($search) ?>" placeholder="Email দিয়ে খুঁজুন..." class="field-narrow">
  <button class="btn btn--sm" type="submit">Search</button>
</form>

<div class="table-wrap">
  <table>
    <thead><tr><th>ID</th><th>Email</th><th>Status</th><th>Registered</th><th></th></tr></thead>
    <tbody>
      ...
      <?php endforeach; ?>
      <?php if ($users === []): ?><tr><td colspan="5" class="muted">কোনো User পাওয়া যায়নি।</td></tr><?php endif; ?>
    </tbody>
  </table>
</div>
